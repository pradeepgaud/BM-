    ...
    <section className="service-section pt-120 mt-15 mb-15 pb-120">
      <div className="auto-container">
        <div className="row g-2">
          ...
          {/* Service 1 */}
          <div className="col-xl-4 col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                ...
                <div className="content-box">
                  ...
                  <Link to="/service-details" className="arrow-link">
                    ...
                    <svg width="19" height="16" viewBox="0 0 19 16">
                      <path d="M0 8.00008L15 8.00008M18.3361 8.01939C15.2241 7.82927 9 9.16017 9 16.0048M18.3361 7.98545C15.2241 8.17558 9 6.84467 9 0" stroke="#FF6B1E" strokeWidth="1.5"/>
                    </svg>
                  </Link>
                </div>
              </div>
          ...
          {/* Service 2 */}
          <div className="col-xl-4 col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
            <div className="service-block-one">
              <div className="inner-block">
                <span className="dot"></span>
          ...
          {/* Service 3 */}
          <div className="col-xl-4 col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
            <div className="service-block-one">
              <div className="inner-block">
                <span className="dot"></span>
