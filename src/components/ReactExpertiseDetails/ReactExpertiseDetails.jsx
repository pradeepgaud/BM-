...
const ReactExpertiseDetails = () => {
  ...
  return (
    <>
      <div className="react-expertise-section">
        <div className="auto-container">
          {/* Section Main Heading - Purely using your theme H3 */}
          <h3 className="mb-5 text-center section-main-h3">
            Our ReactJS Development Expertise
          </h3>

          <div className="react-expertise-grid">
            ...
            <div className="react-expertise-tabs">
              {servicesData.map((service) => (
                ...
                >
                  {/* Button Title - Inheriting H3 styling from your theme */}
    ...
    /* Grid alignment for perfect height sync */
    ...
    /* Targetting H3 inside the button to match theme but keep button-specific behavior */
    .tab-btn-title {
      font-family: var(--heading-font-family) !important;
      font-size: var(--body-font-size) !important; /* Button ke andar size body wala rakha hai readability ke liye */
    ...
    @media (max-width: 768px) {
      .react-expertise-tabs { grid-template-columns: 1fr; }
    }
  `}</style>
      </div>
    </>
